...
- Name: workflow-sidebar.spec.ts >> ticket-viewer — workflow sidebar >> workflow modes preserve server order, hierarchy, evidence, and narrow-width rendering
- Location: e2e-release\workflow-sidebar.spec.ts:466:7

# Error details

```
Error: patch ticket state failed for dcdf3b46-86da-43fe-b661-2611429a5f15 -> ready
